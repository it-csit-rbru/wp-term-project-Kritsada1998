        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-9 col-lg-9">
                    <h4>เพิ่มข้อมูลต้นสังกัด</h4>    
                <?php
                    if(isset($_GET['submit'])){
                          
                        $agency_name = $_GET['agency_name']; 
                        $sql = "insert into agency (agency_name) values ('$agency_name')"; 
                        
                        include 'connectdb.php';
                        if (mysqli_query($conn,$sql)){
                                echo "เพิ่มต้นสังกัด $agency_name เรียบร้อยแล้ว<br>";
                            }else{
                                echo "เพิ่มต้นสังกัด $agency_name ผิดพลาด<br>";
                        }
                        mysqli_close($conn);
                        echo '<a href="agency_list.php">แสดงต้นสังกัดทั้งหมด</a>';
                    }else{
                ?>
                    <form class="form-horizontal" role="form" name="agency_add" action="<?php echo $_SERVER['PHP_SELF']?>">
